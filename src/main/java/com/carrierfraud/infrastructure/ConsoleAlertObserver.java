...
public class ConsoleAlertObserver implements AlertObserver {
    ...
    public void notify(RiskAlert alert) {
        System.out.println("🚨 ALERT: " + alert.getCarrierName() + " | Score: " + alert.getRiskScore() + " | Urgency: " + RiskScoreEvaluator.evaluate(alert.getRiskScore()) + " | " + alert.getAssignmentStatus());
    }
}
