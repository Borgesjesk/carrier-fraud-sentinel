...
/**
 * FraudDetectionServiceTest verifies the full fraud detection pipeline.
 *
 * TESTING STRATEGY:
 * - Mock the fraud rules and repository
 * - Test orchestration logic (running rules, calculating score, creating alert)
 * - Test severity determination
 * - Test routing logic
 *
 * MOCKING:
 * - Rules are mocked to return known scores
 * - Repository is mocked to track save calls
 * - Observers are mocked to verify notifications
 *
 * @ExtendWith(MockitoExtension.class) = enables Mockito @Mock annotations
 */
...
class FraudDetectionServiceTest {
    ...
    void testAnalyse_PaymentAlert_RoutesToPaymentReconciliation() {
        ...
        assertNotNull(alert);
        assertEquals(Department.PAYMENT_RECONCILIATION, alert.getAssignedDepartment(),
